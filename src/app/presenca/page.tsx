          ...
          <div className="modal-card" onClick={e => e.stopPropagation()} style={{ maxWidth: 440, textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {success.student.telefone ? (
                ...
                <div style={{ width: '100%', padding: '14px', background: 'var(--bg-input)', border: '1px solid var(--border)', color: 'var(--text-secondary)', borderRadius: 12, fontSize: '0.85rem', textAlign: 'center' }}>
