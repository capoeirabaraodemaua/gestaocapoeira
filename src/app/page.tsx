...
export default function Home() {
  ...
  const shareCarteirinhaWhatsApp = (telefone: string | null | undefined, nome: string) => {
...
Olá, *${nome}*! Sua carteirinha de associado está disponível. Acesse o link abaixo para visualizar e imprimir:
          ...
          <div className="form-section" style={{ borderTopLeftRadius: 0, marginBottom: 32 }}>
            ...
            {cardData && (
              <div style={{ marginTop: 24, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
                ...
                <button
                  type="button"
                  onClick={() => shareCarteirinhaWhatsApp(cardData.telefone, cardData.nome)}
      ...
      {success && successData && (
        <div className="success-overlay" style={{ overflowY: 'auto', padding: '20px 0' }}>
          <div className="success-card" style={{ maxWidth: 420, width: '95%', padding: '28px 24px' }} onClick={(e) => e.stopPropagation()}>
            ...
            <button
              onClick={() => shareCarteirinhaWhatsApp(successData.telefone, successData.nome)}
