        ...
        <div style={{
          ...
          <div style={{ background: '#dc2626', padding: '16px 24px', textAlign: 'center' }}>
            <div style={{ color: '#fff', fontWeight: 800, fontSize: '1rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
              ⚠ Termo de Consentimento e Responsabilidade — Menor de Idade
            </div>
          </div>
          ...
          <div style={{ padding: '28px 28px 24px', fontFamily: 'Georgia, serif' }}>
            ...
            {/* Texto do termo */}
            <div style={{ textAlign: 'justify', lineHeight: 1.9, marginBottom: 20, fontSize: '0.93rem' }}>
              <p style={{ marginBottom: 14 }}>
                Eu, responsável legal pelo menor inscrito, autorizo sua participação nas atividades de capoeira
                realizadas pela <strong>Associação Cultural de Capoeira Barão de Mauá</strong>, declarando estar
                ciente das práticas físicas envolvidas.
              </p>
              <p style={{ marginBottom: 14 }}>
                Declaro que o menor encontra-se em condições adequadas de saúde para participação nas atividades,
                responsabilizando-me pela veracidade e atualização das informações prestadas.
              </p>
              <p style={{ marginBottom: 14 }}>
                Autorizo, de forma livre, informada e inequívoca, a coleta e o tratamento dos dados pessoais do menor
                e do responsável, incluindo nome completo, CPF, telefone e/ou e-mail e informações sociais, bem como
                dados de localização (GPS), coletados pontualmente no momento do registro de presença, exclusivamente
                para fins de confirmação de participação nas atividades. <em>Não é realizado monitoramento contínuo de localização.</em>
              </p>
              <div style={{ background: 'rgba(220,38,38,0.05)', border: '1px solid rgba(220,38,38,0.2)', borderRadius: 8, padding: '12px 16px', marginBottom: 14 }}>
                <p style={{ fontWeight: 700, marginBottom: 8, fontSize: '0.85rem' }}>🔒 USO DE DADOS PESSOAIS (LGPD)</p>
                <p style={{ marginBottom: 8 }}>Os dados serão utilizados para:</p>
                <ul style={{ paddingLeft: 20, marginBottom: 8, lineHeight: 2 }}>
                  <li>Gestão e cadastro de alunos</li>
                  <li>Controle de presença e frequência</li>
                  <li>Comunicação com responsáveis</li>
                  <li>Organização das atividades</li>
                  <li>Elaboração de relatórios sociais e institucionais</li>
                </ul>
                <p style={{ marginBottom: 8 }}>
                  Os dados serão utilizados exclusivamente pela administração da Associação Cultural de Capoeira Barão de Mauá,
                  com acesso restrito à equipe responsável, não sendo divulgados publicamente.
                </p>
                <p style={{ marginBottom: 8 }}>
                  A associação adota medidas técnicas e administrativas para proteger os dados pessoais contra acessos
                  não autorizados e situações acidentais ou ilícitas.
                </p>
                <p style={{ marginBottom: 8 }}>
                  O tratamento dos dados será realizado em conformidade com o <strong>Estatuto da Criança e do Adolescente (ECA)</strong> e
                  a <strong>Lei Geral de Proteção de Dados (LGPD)</strong>.
                </p>
                <p>Este consentimento poderá ser revogado a qualquer momento mediante solicitação do responsável.</p>
              </div>
            </div>
