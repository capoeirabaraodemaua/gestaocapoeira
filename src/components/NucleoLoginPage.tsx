      ...
      <div style={{
        ...
        {tela === 'login' && (
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            {erro && (
              <div style={{ background: 'rgba(220,38,38,0.12)', border: '1px solid rgba(220,38,38,0.3)', borderRadius: 8, padding: '8px 12px', color: '#f87171', fontSize: '0.78rem', fontWeight: 600, display: 'flex', flexDirection: 'column', gap: 8 }}>
                <span>⚠ {erro}</span>
                {(erro.includes('Aguarde') || erro.includes('bloqueado')) && (
                  <button
                    type="button"
                    onClick={() => { setLockState(0, 0); setErro(''); }}
