...
export const LOCAIS: Local[] = [
  {
    ...
    endereco: 'Av. Gov. Roberto Silveira, s/nº — Praia do Anil, Magé - RJ, CEP 25926-314',
    nucleo: 'Mauá',
    lat: -22.6885,
    lng: -43.1215,
    mapUrl: 'https://maps.google.com/?q=Ginasio+Poliesportivo+Edson+Alves,+Av+Gov+Roberto+Silveira,+Praia+do+Anil,+Mage+RJ',
  },
  {
    id: 'poliesportivo-ipiranga',
    nome: 'Poliesportivo do Ipiranga',
    endereco: 'Av. Nossa Sra. da Guia, 202 — Parque Baia Branca, Magé - RJ, CEP 25903-587',
    nucleo: 'Mauá',
    lat: -22.6480,
    lng: -43.0425,
    mapUrl: 'https://maps.google.com/?q=Av+Nossa+Senhora+da+Guia+202,+Parque+Baia+Branca,+Mage+RJ',
  },
  {
    id: 'polo-saracuruna',
    nome: 'Polo Saracuruna',
    endereco: 'Av. Presidente Roosevelt, s/n — Saracuruna, Duque de Caxias - RJ, CEP 25212-390',
    nucleo: 'Saracuruna',
    lat: -22.6740,
    lng: -43.2561,
    mapUrl: 'https://maps.google.com/?q=Avenida+Presidente+Roosevelt,+Saracuruna,+Duque+de+Caxias+RJ',
  },
];
